<template>
    <div class="app-container">
        <div class="filter-container">
            ...
            <el-input v-model="listQuery.account" placeholder="账号" style="width: 200px;" class="filter-item"
                      @keyup.enter.native="handleFilter"/>
        ...
        >
            ...
            <el-table-column label="头像" align="center">
                <template slot-scope="{row}">
                    <span class="block"><el-avatar shape="square" :size="50" :src="row.head_img"></el-avatar></span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left"
                ...
                <el-form-item label="账号" prop="账号">
                    <el-input v-model="temp.account" placeholder="输入账号"
